...
export const TWITTER_REGEX_GLOBAL = /(https?:\/\/)?(www\.)?(twitter|x)\.com\/([a-zA-Z0-9_]{1,15})(\/status\/(\d+))?(\/\S*)?/g;
export const TWITTER_REGEX = /^https?:\/\/(www\.)?(twitter|x)\.com\/([a-zA-Z0-9_]{1,15})(\/status\/(\d+))?(\/\S*)?$/;
